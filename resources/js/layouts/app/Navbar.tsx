    ...
    return (
        <nav className=' flex w-full justify-between content-center mt-2'>
                ...
                <li>
                    <a className='flex gap-5 py-3 pl-6 pr-24 hover:bg-gray-700 rounded-md cursor-pointer'>
                        <svg width="24" height="21" viewBox="0 0 24 21" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M2.10266 10.2266V17.7351C2.10266 18.665 2.85652 19.4188 3.78644 19.4188H7.15401C7.72019 19.4475 8.19496 18.9962 8.19496 18.4293V13.5219C8.19496 12.5962 8.94219 11.8441 9.86785 11.8382L14.6554 11.8072C15.5895 11.8011 16.35 12.5568 16.35 13.4909V18.5122C16.35 19.0129 16.756 19.4188 17.2567 19.4188H20.6243C21.5542 19.4188 22.3081 18.665 22.3081 17.7351V10.2266C22.3081 9.73131 22.09 9.26114 21.7119 8.94122L13.293 1.81752C12.6652 1.28631 11.7455 1.28631 11.1177 1.81752L2.69882 8.94122C2.32072 9.26114 2.10266 9.73131 2.10266 10.2266Z" fill="#E0E0E0" stroke="#E0E0E0" strokeWidth="2.3573" strokeLinecap="round" strokeLinejoin="round"/>
                        </svg>
                        <span>Home</span>
                    </a>
                </li>
            ...
            <ul className='flex gap-5 items-center'>
                ...
                <li>
                    <a className='flex gap-5 p-2 hover:bg-gray-700 rounded-full w-[32px] h-[32px] cursor-pointer object-fit '>
                        <img alt="profile" />
                    </a>
                </li>
            </ul>
